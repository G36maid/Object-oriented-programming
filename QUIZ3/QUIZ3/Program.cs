    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                tri.Point1X = double.Parse(str);
                str = Console.ReadLine();
                tri.Point1Y = double.Parse(str);

                Console.WriteLine("(x2,y2)=");
                str = Console.ReadLine();
                tri.Point2X = double.Parse(str);
                str = Console.ReadLine();
                tri.Point2Y = double.Parse(str);

                Console.WriteLine("(x3,y3)=");
                str = Console.ReadLine();
                tri.Point3X = double.Parse(str);
                str = Console.ReadLine();
                tri.Point3Y = double.Parse(str);
